...
const RegisterProf = () => {
  ...
  const handleToggleStatus = async (prof_id, currentStatus) => {
    ...
    try {
      ...
      await axios.put(
        `${API_BASE_URL}/api/update_prof_status/${prof_id}`,
        {
          status: newStatus,
        },
        permissionHeaders,
        ...
        <DialogContent sx={{ p: 3 }}>
          ...
          {editData && !form.password && (
            <Typography variant="body2" color="text.secondary" mt={2}>
              Current passwords are encrypted and cannot be viewed. Generate a new password here to reset it for this faculty account.
            </Typography>
          )}
