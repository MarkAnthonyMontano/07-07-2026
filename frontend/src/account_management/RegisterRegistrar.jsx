...
const RegisterRegistrar = () => {
  ...
  const handleToggleStatus = async (id, currentStatus) => {
    ...
    try {
      await axios.put(
        `${API_BASE_URL}/api/update_registrar_status/${id}`,
        { status: newStatus },
        permissionHeaders,
      );
  ...
  return (
    ...
    >
              ...
              >
                ...
                >
                  ...
                  <Typography fontSize="14px" fontWeight="bold" color="white">
                    Total Registrar Account's: {filteredRegistrar.length}{" "}
                    account{filteredRegistrar.length !== 1 ? "s" : ""}
                  </Typography>
      ...
      <TableContainer
        component={Paper}
        sx={{ width: "100%", border: `1px solid ${borderColor}`, mb: 4 }}
      >
        <Table>
          <TableHead
